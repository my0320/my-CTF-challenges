...
## About The Challenge
We were given the server to access: nc verbal-sleep.picoctf.net 52485
...
(Recommended [website](https://www.dcode.fr/sha1-hash))

![preview](images/hash2.png)

3. I get the third hash value. I used SHA-256 to decode it and get the flag inside.

(Recommended [website](https://www.dcode.fr/sha256-hash))
